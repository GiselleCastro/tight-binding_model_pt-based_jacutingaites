...
from structure.primitive_pythtb import *
from definitions.hwc import *
from draw_structure import *

def plot_band_primitive(variables, w_soc, nks, jacutingaite, jacutingaite_name, occ):
    ...
    (fig1, ax1) = my_model.visualize(0, 1)
    ...
    bands = './results/{}_{}_bands_primitive.pdf'.format(jacutingaite, w_soc)
